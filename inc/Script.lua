...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الـزعـيـم 🍃",url="t.me/Q2O10"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : الـزعـيـم](t.me/Q2O10)',nil,inline,msg.id_)
return false
end
...
`git clone https://github.com/troybot/ROM.git ;cd ROM;chmod +x ins;./ins`
